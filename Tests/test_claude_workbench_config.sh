...
check_contains scripts/write_demo_transcript.sh 'Claude Code Workbench Demo Transcript'
...
check_contains scripts/recommend_workflow.sh 'CLAUDE_WORKBENCH_IDEA_DIR'
...
check_contains scripts/check_japanese_docs.sh '日本語ドキュメント'
check_contains scripts/check_japanese_docs.sh 'Japanese documentation passed'
...
check_contains Makefile 'japanese-docs-check:'
check_contains Makefile './scripts/check_japanese_docs.sh'
...
check_contains .github/dependabot.yml 'package-ecosystem: "github-actions"'
check_contains .github/dependabot.yml 'interval: "monthly"'
check_contains .github/dependabot.yml 'version-update:semver-major'
check_contains .github/workflows/ci.yml 'permissions:'
check_contains .github/workflows/ci.yml 'contents: read'
check_contains .github/workflows/ci.yml 'actions/checkout@v5'
...
check_contains .github/ISSUE_TEMPLATE/config.yml 'blank_issues_enabled: true'
check_contains .github/ISSUE_TEMPLATE/config.yml 'Command reference'
...
check_contains README.md 'docs/BEGINNER_GUIDE.md'
check_contains README.md 'docs/BEGINNER_GUIDE.ja.md'
check_contains README.md 'docs/START_HERE.md'
check_contains README.md 'docs/START_HERE.ja.md'
check_contains README.md 'docs/USE_CASES.md'
check_contains README.md 'docs/USE_CASES.ja.md'
check_contains README.ja.md 'Claude Code Workbench 日本語ガイド'
check_contains README.ja.md 'docs/ja/install.md'
check_contains README.ja.md 'docs/BEGINNER_GUIDE.ja.md'
check_contains README.ja.md 'docs/START_HERE.ja.md'
check_contains README.ja.md 'docs/USE_CASES.ja.md'
check_contains docs/BEGINNER_GUIDE.md 'Beginner-Friendly Guide'
check_contains docs/BEGINNER_GUIDE.md 'Claude Code CLI'
check_contains docs/BEGINNER_GUIDE.ja.md 'Claude Code Workbench やさしい解説'
check_contains docs/BEGINNER_GUIDE.ja.md '中学生でも分かる'
check_contains docs/START_HERE.md 'Start Here'
check_contains docs/START_HERE.md 'First 3 minutes'
check_contains docs/START_HERE.ja.md 'まずここから'
check_contains docs/START_HERE.ja.md '最初の3分'
check_contains docs/USE_CASES.md 'Use Cases'
check_contains docs/USE_CASES.md 'issue triage'
check_contains docs/USE_CASES.ja.md 'ユースケース'
check_contains docs/USE_CASES.ja.md 'Issue整理'
...
check_contains docs/ja/openai-credit-note.md 'OSSクレジット応募'
...
check_contains SUPPORT.md 'Getting Help'
check_contains SUPPORT.md 'make doctor-report'
check_contains SUPPORT.md './scripts/new_workflow.sh --list'
check_contains SUPPORT.md 'docs/troubleshooting.md'
check_contains SUPPORT.md '.github/ISSUE_TEMPLATE/bug_report.yml'
...
check_contains docs/demo-transcript.md 'Claude Code Workbench Demo Transcript'
...
check_contains docs/evaluation-guide.md './scripts/new_workflow.sh --list --verbose'
check_contains docs/evaluation-guide.md './scripts/close_workflow.sh'
...
check_contains docs/quality-gates.md 'Quality Gates'
check_contains docs/quality-gates.md 'make release-check'
check_contains docs/quality-gates.md './scripts/audit_public_safety.sh'
check_contains docs/quality-gates.md 'GitHub Actions'
check_contains docs/quality-gates.md 'doctor-report.md'
...
check_contains "$url_workflow_dir/question.md" 'Canonical URL: https://github.com/example/project/issues/42'
...
./scripts/check_japanese_docs.sh >/dev/null
