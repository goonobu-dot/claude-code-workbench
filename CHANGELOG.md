...
- Added minimal GitHub Actions permissions and Dependabot coverage for non-major workflow updates.
...
- Added a generated 50-step continuous improvement loop log and `make continuous-improvement-check`.
...
- Added macOS/tmux Claude Code workbench.
